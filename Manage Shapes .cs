                ...
                switch (shapeType.ToLower())
                {
                    ...
                    inputLength:
                        ...
                        if (!double.TryParse(Console.ReadLine(), out length) || length <= 0)
                        {
                            ...
                            goto inputLength; // Go back to inputLength label
                        }
                    ...
                    inputWidth:
                        ...
                        if (!double.TryParse(Console.ReadLine(), out width) || width <= 0)
                        {
                            ...
                            goto inputWidth; // Go back to inputWidth label
                        }
                    ...
                    inputBase:
                        ...
                        if (!double.TryParse(Console.ReadLine(), out triangleBase) || triangleBase <= 0)
                        {
                            ...
                            goto inputBase; // Go back to inputBase label
                        }
                    ...
                    inputHeight:
                        ...
                        if (!double.TryParse(Console.ReadLine(), out height) || height <= 0)
                        {
                            ...
                            goto inputHeight; // Go back to inputHeight label
                        }
